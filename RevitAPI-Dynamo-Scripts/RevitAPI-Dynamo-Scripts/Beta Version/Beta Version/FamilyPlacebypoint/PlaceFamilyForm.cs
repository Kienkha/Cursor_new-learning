    ...
    public partial class PlaceFamilyForm : System.Windows.Forms.Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                NS = UnitUtils.ConvertToInternalUnits( Convert.ToDouble(nsstr), displayUnitType);
        ...
        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                DisplayUnitType displayUnitType = doc.GetUnits().GetFormatOptions(UnitType.UT_Length).DisplayUnits;
                EW = UnitUtils.ConvertToInternalUnits(Convert.ToDouble(ewstr), displayUnitType);
            }
            catch
            {
                TaskDialog.Show("Warning", "entered value seems String please Enter Double");
        ...
        private void textBox3_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                DisplayUnitType displayUnitType = doc.GetUnits().GetFormatOptions(UnitType.UT_Length).DisplayUnits;
                elev = UnitUtils.ConvertToInternalUnits(Convert.ToDouble(elevstr), displayUnitType);
            }
            catch
            {
                TaskDialog.Show("Warning", "entered value seems String please Enter Double");
